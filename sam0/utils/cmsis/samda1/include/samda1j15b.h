 ...
 * \file
 *
 * \brief Header file for SAMDA1J15B
 *
 ...
 * \addtogroup SAMDA1J15B_definitions SAMDA1J15B definitions
 * This file defines all structures and symbols for SAMDA1J15B:
...
/* ************************************************************************** */
/**  CMSIS DEFINITIONS FOR SAMDA1J15B */
/* ************************************************************************** */
/** \defgroup SAMDA1J15B_cmsis CMSIS Definitions */
/*@{*/
...
typedef enum IRQn
{
  ...
  /******  SAMDA1J15B-specific Interrupt Numbers ***********************/
  PM_IRQn                  =  0, /**<  0 SAMDA1J15B Power Manager (PM) */
  SYSCTRL_IRQn             =  1, /**<  1 SAMDA1J15B System Control (SYSCTRL) */
  WDT_IRQn                 =  2, /**<  2 SAMDA1J15B Watchdog Timer (WDT) */
  RTC_IRQn                 =  3, /**<  3 SAMDA1J15B Real-Time Counter (RTC) */
  EIC_IRQn                 =  4, /**<  4 SAMDA1J15B External Interrupt Controller (EIC) */
  NVMCTRL_IRQn             =  5, /**<  5 SAMDA1J15B Non-Volatile Memory Controller (NVMCTRL) */
  DMAC_IRQn                =  6, /**<  6 SAMDA1J15B Direct Memory Access Controller (DMAC) */
  USB_IRQn                 =  7, /**<  7 SAMDA1J15B Universal Serial Bus (USB) */
  EVSYS_IRQn               =  8, /**<  8 SAMDA1J15B Event System Interface (EVSYS) */
  SERCOM0_IRQn             =  9, /**<  9 SAMDA1J15B Serial Communication Interface 0 (SERCOM0) */
  SERCOM1_IRQn             = 10, /**< 10 SAMDA1J15B Serial Communication Interface 1 (SERCOM1) */
  SERCOM2_IRQn             = 11, /**< 11 SAMDA1J15B Serial Communication Interface 2 (SERCOM2) */
  SERCOM3_IRQn             = 12, /**< 12 SAMDA1J15B Serial Communication Interface 3 (SERCOM3) */
  SERCOM4_IRQn             = 13, /**< 13 SAMDA1J15B Serial Communication Interface 4 (SERCOM4) */
  SERCOM5_IRQn             = 14, /**< 14 SAMDA1J15B Serial Communication Interface 5 (SERCOM5) */
  TCC0_IRQn                = 15, /**< 15 SAMDA1J15B Timer Counter Control 0 (TCC0) */
  TCC1_IRQn                = 16, /**< 16 SAMDA1J15B Timer Counter Control 1 (TCC1) */
  TCC2_IRQn                = 17, /**< 17 SAMDA1J15B Timer Counter Control 2 (TCC2) */
  TC3_IRQn                 = 18, /**< 18 SAMDA1J15B Basic Timer Counter 3 (TC3) */
  TC4_IRQn                 = 19, /**< 19 SAMDA1J15B Basic Timer Counter 4 (TC4) */
  TC5_IRQn                 = 20, /**< 20 SAMDA1J15B Basic Timer Counter 5 (TC5) */
  TC6_IRQn                 = 21, /**< 21 SAMDA1J15B Basic Timer Counter 6 (TC6) */
  TC7_IRQn                 = 22, /**< 22 SAMDA1J15B Basic Timer Counter 7 (TC7) */
  ADC_IRQn                 = 23, /**< 23 SAMDA1J15B Analog Digital Converter (ADC) */
  AC_IRQn                  = 24, /**< 24 SAMDA1J15B Analog Comparators  (AC) */
  DAC_IRQn                 = 25, /**< 25 SAMDA1J15B Digital Analog Converter (DAC) */
  PTC_IRQn                 = 26, /**< 26 SAMDA1J15B Peripheral Touch Controller (PTC) */
  I2S_IRQn                 = 27, /**< 27 SAMDA1J15B Inter-IC Sound Interface (I2S) */
...
/* ************************************************************************** */
/**  SOFTWARE PERIPHERAL API DEFINITION FOR SAMDA1J15B */
/* ************************************************************************** */
/** \defgroup SAMDA1J15B_api Peripheral Software API */
/*@{*/
...
/* ************************************************************************** */
/**  REGISTERS ACCESS DEFINITIONS FOR SAMDA1J15B */
/* ************************************************************************** */
/** \defgroup SAMDA1J15B_reg Registers Access Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  PERIPHERAL ID DEFINITIONS FOR SAMDA1J15B */
/* ************************************************************************** */
/** \defgroup SAMDA1J15B_id Peripheral Ids Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  BASE ADDRESS DEFINITIONS FOR SAMDA1J15B */
/* ************************************************************************** */
/** \defgroup SAMDA1J15B_base Peripheral Base Address Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  PORT DEFINITIONS FOR SAMDA1J15B */
/* ************************************************************************** */
/** \defgroup SAMDA1J15B_port PORT Definitions */
/*@{*/

#include "pio/samda1j15b.h"
/*@}*/

/* ************************************************************************** */
/**  MEMORY MAPPING DEFINITIONS FOR SAMDA1J15B */
/* ************************************************************************** */
...
#define DSU_DID_RESETVALUE    _UL(0x10011565)
...
/* ************************************************************************** */
/**  ELECTRICAL DEFINITIONS FOR SAMDA1J15B */
/* ************************************************************************** */
